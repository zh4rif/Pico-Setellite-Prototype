...
root.protocol("WM_DELETE_WINDOW", stop_update) 
...
def update_battery_monitoring():
    ...
    current = 0.2  # Assume a current of 0.2A for demonstration
...
update_thread = threading.Thread(target=update_readings_thread)
